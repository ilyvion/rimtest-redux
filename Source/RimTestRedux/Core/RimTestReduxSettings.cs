    ...
    public class RimTestReduxSettings : ModSettings
    {
       ...
       /// </summary>
        ...
        public void DoWindowContents(Rect canvas)
        {
            ...
            options.CheckboxLabeled("Include RimTest Redux' own test suite", ref RunOwnTests, "if enabled, RimTestRedux will run its' own test suite as well as any mod test suites.");
            options.CheckboxLabeled("Run tests at startup", ref RunAtStartup, "if enabled, RimTestRedux will run every valid tests at the game startup.");
            options.GapLine();
