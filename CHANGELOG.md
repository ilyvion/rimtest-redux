...
- The test runner window's toolbar has been redesigned. The old rows of bare numbers and checkmarks have been replaced with icon buttons and colored status badges (failed, warning, skipped, not run, passed), each with a tooltip explaining what it does.
